...
class CABC:
    ...
    def __init__(self, run_id, cpu_time_limit, employed_bees_num, nK, nI, Capacity, Profits, Weights, onlooker_bees_num, max_try_improve, pc, pm, k_tournomet, selection_type, crossover_type, result_file_name):
    ...
    def optimize(self):
        ...
        while(elapsed_time<self.cpu_time_limit):
            ...
            elapsed_time = current_time-start_limitation_time
    ...
    def write_results(self, best_fitnesses_of_iterations, best_final_bee, best_final_fitness, total_iteration_num, st):
        ...
        result.write(f"probability of crossover = {self.pc}\n")
    ...
    def write_excel(self, run_id, category, problem_num, cpu_time_limit, employed_bees_num, max_try_improve, pc, pm, selection_type, k_tournomet, crossover_type, best_final_fitness, best_fitness_iteration_num, best_fitness_time, total_iteration_num):
