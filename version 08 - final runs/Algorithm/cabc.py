...
class Classic_Artificial_Bee_Colony:
    ...
    def __init__(self, run_id, cpu_time_limit, employed_bees_num, nK, nI, Capacity, Profits, Weights, onlooker_bees_num, max_try_improve, pc_onePoint, pc_uniForm, pm, k_tournoment, selection_type, crossover_type, result_file_name):
        ...
        self.pm = pm
        self.k_tournoment = k_tournoment
    ...
    def write_excel(self, run_id, category, problem_num, cpu_time_limit, employed_bees_num, max_try_improve, pc_onePoint, pc_uniForm, pm, selection_type, k_tournoment, crossover_type, best_final_fitness, best_fitness_iteration_num, best_fitness_time, total_iteration_num):
